...
namespace Julien.Script.Static
{
    public static class GameManagerStatic
    {
        ...
        public static List<Vector4> Anchor = new List<Vector4>{new Vector4(0,0.84f,0.175f,1),new Vector4(0.825f,0.84f,1,1),new Vector4(0,0,0.175f,0.16f),new Vector4(0.825f,0,1,0.16f)};
